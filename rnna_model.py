...
def train_molecule_model_RNN_FCNN(model_name, model_version, x_train, x_test, batch_size, epochs, callbacks=None):
...
def train_protein_model_CONV_CONV(model_name, model_version, x_train, x_test, batch_size, epochs, callbacks=None):
    ...
    prot_autoencoder.load_weights(checkpoint_path(model_name))
...
def run_train_session_ba(dataset_name):
    ...
    mol_train_latent_vec, mol_test_latent_vec = train_molecule_model_RNN_FCNN('mol_auto_RNN_FCNN', 1, mol_train, mol_test, 256, 50)
