...
# print(len(mol_train), "length of training molecules")
# print(len(mol_test), "length of test molecules")
# print(f'\n\nxtrain[0]: {mol_train[0]}\n\n')
# # mol_train = keras.preprocessing.sequence.pad_sequences(mol_train, maxlen=maxlen)
# # mol_test = keras.preprocessing.sequence.pad_sequences(mol_test, maxlen=maxlen)
