...
# experiments.run_autoencoder_train_session(models, 1, 'kiba', epochs=1, batch_size=2)
...
# experiments.run_autoencoder_train_session(models, 1, 'kiba', epochs=1, batch_size=2)
# experiments.run_autoencoder_train_session(models, 2, 'davis', epochs=1, batch_size=2)
