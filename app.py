...
experiments.run_autoencoder_train_session(models, 1, 'kiba', epochs=10, batch_size=256)
# experiments.run_autoencoder_train_session(models, 2, 'davis', epochs=10, batch_size=256)
# models = ['arnn', 'arnn_molecule_RNN_RNN', 'arnn_protein_RNN_RNN', 'arnn_interaction_RNN_RNN']
# experiments.run_autoencoder_train_session(models, 1, 'kiba', epochs=100, batch_size=2)
# experiments.run_autoencoder_train_session(models, 2, 'davis', epochs=100, batch_size=2)
